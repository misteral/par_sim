...
select tov.product_sku as sku, tov.product_desc as desk, tov.product_full_image as image, tov.product_name as name, tov.product_price as price, tov.product_margin as margin
